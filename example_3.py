...
print("Введіть код ASCII першого символу")
ascii_value_1 = int(input())
print("Введіть код ASCII другого символу")
ascii_value_2 = int(input())
print("Введіть код ASCII третього символу")
ascii_value_3 = int(input())
